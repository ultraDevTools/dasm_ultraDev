...
/*
 *  MNEWDC65c02.C
 *  Processor definition for:
 *  ultraDev
 *  Retro development Cartridge
 */
...
MNEMONIC Mne65ud32[] = {
	#include "mne65ud32NewInstructions.h"
...
/*    { NULL, v_mnemonic, "lda", 0, AF_REGXL, { 0x1f } },
    { NULL, v_mnemonic, "lda", 0, AF_REGXW, { 0x2f } },
    { NULL, v_mnemonic, "lda", 0, AF_REGUXB, { 0x3f } },
    { NULL, v_mnemonic, "lda", 0, AF_REGUYW, { 0x4f } },
    { NULL, v_mnemonic, "lda", 0, AF_W_FROM_WORDADR, { 0x5f } },
    { NULL, v_mnemonic, "lda", 0, AF_L_FROM_WORDADR, { 0x6f } },
    { NULL, v_mnemonic, "lda", 0, AF_IMM32, { 0xff } },
    { NULL, v_mnemonic, "lda", 0, AF_IMM16, { 0xfe } },
    { NULL, v_mnemonic, "ldua", 0, AF_REGUX, { 0x5f } },
*/
